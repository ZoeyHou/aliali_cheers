$(document).ready(function(){
	...
	var k;
	var v= new Array();
	v[0] = document.getElementById("animation_display");
	v[1] = document.getElementById("music_display");
	v[2] = document.getElementById("gaming_display");
	v[3] = document.getElementById("tech_display");
	v[4] = document.getElementById("entertainment_display");
	v[5] = document.getElementById("TV_display");
	v[6] = document.getElementById("life_display");
	v[7] = document.getElementById("fashion_display");
